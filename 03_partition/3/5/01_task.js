...
// Ответ: Origin нужен, так как Referer необязательный параметр и может отсутствовать,
// по спецификации браузер гарантирует правильность Origin при запросах на сторонние источники